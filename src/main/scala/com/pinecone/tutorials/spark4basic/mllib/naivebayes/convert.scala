package com.pinecone.tutorials.spark4basic.mllib.naivebayes
...
object convert {
  def main(args: Array[String]) {
    ...
    val hdfsServer = "hdfs://Hadoop-NameNode:9000"
    //-------------------------------------------------------------------------------------
    ...
    val appName = "Convert"
//    System.setProperty("hadoop.home.dir", "/Users/leeivan/hadoop-2.7.2")
