...
object ChapterSixExample {
  ...
  def main(args: Array[String]) {
    val inputFile = "files/callsigns"
    val inputFile2 = "files/callsigns"
    val outputDir = "file:///D:/callsign-" + System.currentTimeMillis()
    val sc = new SparkContext(new SparkConf().setMaster("local").setAppName("AdvancedSparkProgramming"))
    ...
    println("callSigns: " + callSigns.collect().mkString(" "))
    ...
    println("validSigns: " + validSigns.collect().mkString(" "))
    ...
    println("signPrefixes: " + signPrefixes.value.mkString(" "))
